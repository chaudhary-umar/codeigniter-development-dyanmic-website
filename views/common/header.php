...
<html>
   <head>
      ...
      <!--<script>window.bugsnagClient = bugsnag('02b3d87af6347c8437b380853bc1d96c')</script>-->
      <script src="//d2wy8f7a9ursnm.cloudfront.net/v5/bugsnag.min.js"></script>
      <script>window.bugsnagClient = bugsnag('df34a66e3a6a0f0b00de5bd628cd6432')</script>
   </head>
   <body>
      <!-- Small modal -->
